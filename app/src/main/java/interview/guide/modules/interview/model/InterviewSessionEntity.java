...
@Table(name = "interview_sessions", indexes = {
    ...
    @Index(name = "idx_interview_session_jd_created", columnList = "jd_id,created_at")
})
public class InterviewSessionEntity {
    ...
    @Column(length = 20)
    private SessionSourceType sourceType = SessionSourceType.LEGACY;
    ...
    public void setSourceType(SessionSourceType sourceType) {
    ...
    public String getResumeFilenameSnapshot() {
        return resumeFilenameSnapshot;
    }

    public void setResumeFilenameSnapshot(String resumeFilenameSnapshot) {
    ...
    public void setContextSnapshotJson(String contextSnapshotJson) {
