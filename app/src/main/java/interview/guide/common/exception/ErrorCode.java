...
public enum ErrorCode {
    ...
    // ========== 岗位匹配模块错误 9xxx ==========
    JOB_DESCRIPTION_NOT_FOUND(9001, "岗位描述不存在"),
    JOB_DESCRIPTION_PARSE_FAILED(9002, "岗位描述解析失败"),
    JOB_URL_FETCH_FAILED(9003, "岗位 URL 抓取失败"),
    JOB_MATCHING_NOT_FOUND(9004, "岗位匹配结果不存在"),
    JOB_MATCHING_ANALYSIS_FAILED(9005, "岗位匹配分析失败"),
    LEARNING_PATH_GENERATION_FAILED(9006, "学习路径生成失败"),
    MCP_RESOURCE_FETCH_FAILED(9007, "MCP 资源获取失败");
