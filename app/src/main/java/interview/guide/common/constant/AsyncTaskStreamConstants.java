...
public final class AsyncTaskStreamConstants {
     ...
     * JD 解析 Stream Key
     */
    public static final String JD_PARSE_STREAM_KEY = "jd:parse:stream";

    /**
     * JD 解析 Consumer Group 名称
     */
    public static final String JD_PARSE_GROUP_NAME = "jd-parse-group";

    /**
     * JD 解析 Consumer 名称前缀
     */
    public static final String JD_PARSE_CONSUMER_PREFIX = "jd-parse-consumer-";

    /**
     * JD ID 字段
     */
    public static final String FIELD_JD_ID = "jdId";
     ...
     * 岗位匹配分析 Stream Key
     */
    public static final String JOB_MATCHING_ANALYZE_STREAM_KEY = "job:matching:analyze:stream";

    /**
     * 岗位匹配分析 Consumer Group 名称
     */
    public static final String JOB_MATCHING_ANALYZE_GROUP_NAME = "job-matching-analyze-group";

    /**
     * 岗位匹配分析 Consumer 名称前缀
     */
    public static final String JOB_MATCHING_ANALYZE_CONSUMER_PREFIX = "job-matching-analyze-consumer-";

    /**
     * 匹配分析 ID 字段
     */
    public static final String FIELD_MATCHING_ID = "matchingId";

    /**
     * 学习周期字段（周）
     */
    public static final String FIELD_DURATION_WEEKS = "durationWeeks";
}
