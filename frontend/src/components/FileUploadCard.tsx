...
export default function FileUploadCard({
  ...
  return (
    ...
    >
      ...
      {/* 上传区域 */}
      <motion.div
        className={`upload-glow-shell relative bg-white rounded-2xl p-12 cursor-pointer transition-all duration-300
          ${dragOver ? 'upload-glow-shell--active scale-[1.02] shadow-xl' : 'shadow-lg hover:shadow-xl'}`}
